...
obj
	Compost
		...
		DblClick()
			...
			usr.lastaction = "searching compost"
			usr:setBusy(1)
			...
			spawn(WORMS_SPEED)
				...
				usr.lastaction = "found : Earthworms"
	...
	Plowed_Land
		...
		DblClick()
			...
			usr.lastaction = "filling in : land"
			usr:setBusy(1)
	...
	plant
		...
		Grass
			...
			DblClick()
				...
				usr.lastaction = "digging out : grass"
		...
		DblClick()
			...
			usr.lastaction = "gathering from : [src]"
			usr:setBusy(1)
	...
	item
		...
		fertilizer
			MouseDrop(obj/Plowed_Land/over_obj)
				...
				usr.lastaction = "fertilizing land"
